 ...
 * task #: 2
 * file name: 2-print_permissions.c
 * file type: c
 * dependent file(s): print_char.c, Makefile (used to compile program)
 *
 * summary: this program prints the permissions of a file without printf.
 *
